import type { FilterArrayByValue, UndefinedIfNever } from "@zodios/core/lib/utils.types";
...
// dprint-ignore
export type ButtonContext<B extends FormButton[]> = UndefinedIfNever<FilterArrayByValue<B, { form: 'submit' }>[number]['context']>;
