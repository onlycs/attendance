...
export type DepOutput<
    I extends Items,
    K extends keyof I,
    D extends Deps<I>,
> = K extends keyof D ? ItemOutput<I[K]> | undefined : ItemOutput<I[K]>;
...
export type DependentOutputs<
    I extends Items,
    K extends keyof I & keyof D,
    D extends Deps<I>,
> =
    | ({ [_K in K]: ItemOutput<I[K]> } & {
          [K2 in keyof D[K]]: DepValue<D[K][K2]>;
      })
    | ({ [_K in K]?: never } & {
          [K2 in keyof D[K] & keyof I]: Exclude<
              ItemOutput<I[K2]>,
              DepValue<D[K][K2]>
          >;
      });

export type FormOutput<I extends Items, D extends Deps<I>> = IndependentOutputs<
    I,
    D
> &
