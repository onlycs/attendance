 ...
 */
export function decrypt(ctxts, k1) {
    const ptr0 = passArrayJsValueToWasm0(ctxts, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(k1, wasm.__wbindgen_malloc);
 ...
 * @returns {string[] | undefined}
 */
export function encrypt(ptxts, k1) {
    const ptr0 = passArrayJsValueToWasm0(ptxts, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(k1, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
 ...
 */
export function k1_decrypt(k1e, password) {
    const ptr0 = passStringToWasm0(k1e, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(password, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.k1_decrypt(ptr0, len0, ptr1, len1);
    let v3;
    if (ret[0] !== 0) {
 ...
 * @returns {string | undefined}
 */
export function k1_encrypt(k1, password) {
    const ptr0 = passArray8ToWasm0(k1, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(password, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.k1_encrypt(ptr0, len0, ptr1, len1);
    let v3;
    if (ret[0] !== 0) {
...
export function random_bytes(len) {
    const ret = wasm.random_bytes(len);
...
function __wbg_get_imports(memory) {
    ...
    imports.wbg.__wbg_error_f254d301058fb0da = function(arg0, arg1) {
        console.error(getStringFromWasm0(arg0, arg1));
    };
...
async function __wbg_init(module_or_path, memory) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('attendance_crypto_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports(memory);
